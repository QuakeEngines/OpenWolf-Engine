...
{
public:
    virtual bool StringToAdr( StringEntry s, netadr_t* a, netadrtype_t family ) = 0;
    virtual bool CompareBaseAdrMask( netadr_t a, netadr_t b, S32 netmask ) = 0;
    virtual bool CompareBaseAdr( netadr_t a, netadr_t b ) = 0;
    virtual StringEntry AdrToString( netadr_t a ) = 0;
    virtual StringEntry AdrToStringwPort( netadr_t a ) = 0;
    ...
    virtual void SendPacket( S32 length, const void* data, netadr_t to ) = 0;
