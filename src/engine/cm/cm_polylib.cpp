...
//
// -------------------------------------------------------------------------------------
// File name:   cm_polylib.cpp
// Version:     v1.01
// Created:
// Compilers:   Visual Studio 2019, gcc 7.3.0
// Description: this is only used for visualization tools in cm_ debug functions
// -------------------------------------------------------------------------------------
////////////////////////////////////////////////////////////////////////////////////////
...
============
*/
void WindingPlane( winding_t* w, vec3_t normal, F32* dist )
{
    vec3_t v1, v2;
...
=================
*/
winding_t* BaseWindingForPlane( vec3_t normal, F32 dist )
{
    S32             i, x;
    F32           max, v;
    ...
    VectorMA( vup, ( F32 ) - dot, normal, vup );
    VectorNormalize( vup );
...
=============
*/
void ClipWindingEpsilon( winding_t* in, vec3_t normal, F32 dist, F32 epsilon, winding_t** front, winding_t** back )
{
    F32           dists[MAX_POINTS_ON_WINDING + 4] = { 0 }, *p1, *p2;
...
=============
*/
void ChopWindingInPlace( winding_t** inout, vec3_t normal, F32 dist, F32 epsilon )
{
    winding_t*      in;
    F32           dists[MAX_POINTS_ON_WINDING + 4] = { 0 };
    S32             sides[MAX_POINTS_ON_WINDING + 4] = { 0 }, counts[3], i, j, maxpts;
    F64 d1, d2, dot;
    F32*          p1, *p2;
    vec3_t          mid;
...
=================
*/
winding_t* ChopWinding( winding_t* in, vec3_t normal, F32 dist )
{
    winding_t* f, *b;
...
{
    S32             i, j;
    F32*          p1, *p2, d, edgedist, area, facedist;
...
============
*/
S32 WindingOnPlaneSide( winding_t* w, vec3_t normal, F32 dist )
{
    bool        front, back;
    S32             i;
    F32           d;
