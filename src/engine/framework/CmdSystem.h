...
public:
    ...
    static void RemoveCommandSafe( StringEntry cmdName );
    static void ArgsSanitize( void );
    static UTF8* MacroExpandString( UTF8* text );
    ...
    static void TokenizeString2( StringEntry text_in, bool ignoreQuotes, bool parseCvar, bool macroExpand );
};
