...
void idParseSystemLocal::CreatePunctuationTable( script_t* script, punctuation_t* punctuations )
{
    ...
    {
        script->punctuationtable = ( punctuation_t** )memorySystem->Malloc( 256 * sizeof( punctuation_t* ) );
    }
    ...
    for ( i = 0; punctuations[i].p; i++ )
    {
        ...
        for ( p = script->punctuationtable[( U32 ) newp->p[0]]; p; p = p->next )
        {
            if ( ::strlen( p->p ) < ::strlen( newp->p ) )
            {
                ...
                {
                    script->punctuationtable[( U32 )newp->p[0]] = newp;
                }
                break;
            }
...
===============
*/
void idParseSystemLocal::ScriptError( script_t* script, UTF8* str, ... )
{
    va_list argptr;
    UTF8 text[8192];
...
===============
*/
void idParseSystemLocal::ScriptWarning( script_t* script, UTF8* str, ... )
{
    va_list argptr;
    UTF8 text[8192];
...
===============
*/
S32 idParseSystemLocal::ReadWhiteSpace( script_t* script )
{
    while ( 1 )
    {
        //skip white space
...
===============
*/
S32 idParseSystemLocal::ReadEscapeCharacter( script_t* script, UTF8* ch )
{
    S32 c, val, i;
    ...
    switch ( *script->script_p )
    {
        ...
        default: //NOTE: decimal ASCII code, NOT octal
        {
            ...
            {
                ScriptError( script, "unknown escape UTF8" );
            }
...
===============
*/
S32 idParseSystemLocal::ReadString( script_t* script, token_t* token, S32 quote )
{
    S32 len, tmpline;
    UTF8* tmpscript_p;
...
===============
*/
S32 idParseSystemLocal::ReadName( script_t* script, token_t* token )
{
    S32 len = 0;
    UTF8 c;
...
===============
*/
void idParseSystemLocal::NumberValue( UTF8* string, S32 subtype, U64* intvalue, F64* floatvalue )
{
    U64 dotfound = 0;
...
===============
*/
S32 idParseSystemLocal::ReadNumber( script_t* script, token_t* token )
{
    S32 len = 0, i;
    S32 octal, dot;
    UTF8 c;
...
===============
*/
S32 idParseSystemLocal::ReadPunctuation( script_t* script, token_t* token )
{
    S32 len;
    UTF8* p;
    punctuation_t* punc;
...
===============
*/
S32 idParseSystemLocal::ReadPrimitive( script_t* script, token_t* token )
{
    S32 len;
...
===============
*/
S32 idParseSystemLocal::ReadScriptToken( script_t* script, token_t* token )
{
...
===============
*/
void idParseSystemLocal::StripDoubleQuotes( UTF8* string )
{
    if ( *string == '\"' )
    {
...
===============
*/
S32 idParseSystemLocal::EndOfScript( script_t* script )
{
...
===============
*/
script_t* idParseSystemLocal::LoadScriptFile( StringEntry filename )
{
    S32 length;
    void* buffer;
    fileHandle_t fp;
...
===============
*/
script_t* idParseSystemLocal::LoadScriptMemory( UTF8* ptr, S32 length, UTF8* name )
{
    void* buffer;
    script_t* script;
...
===============
*/
void idParseSystemLocal::SourceError( source_t* source, UTF8* str, ... )
{
    va_list argptr;
    UTF8 text[8192];
...
===============
*/
void idParseSystemLocal::SourceWarning( source_t* source, UTF8* str, ... )
{
    va_list argptr;
    UTF8 text[8192];
...
===============
*/
void idParseSystemLocal::PushIndent( source_t* source, S32 type, S32 skip )
{
    indent_t* indent;
...
===============
*/
void idParseSystemLocal::PopIndent( source_t* source, S32* type, S32* skip )
{
    indent_t* indent;
...
===============
*/
S32 idParseSystemLocal::ReadSourceToken( source_t* source, token_t* token )
{
    token_t* t;
    script_t* script;
    S32 type, skip, lines;
...
===============
*/
S32 idParseSystemLocal::UnreadSourceToken( source_t* source, token_t* token )
{
    token_t* t;
...
===============
*/
S32 idParseSystemLocal::ReadDefineParms( source_t* source, define_t* define, token_t** parms, S32 maxparms )
{
...
===============
*/
S32 idParseSystemLocal::StringizeTokens( token_t* tokens, token_t* token )
{
    token_t* t;
...
===============
*/
S32 idParseSystemLocal::MergeTokens( token_t* t1, token_t* t2 )
{
...
===============
*/
S32 idParseSystemLocal::NameHash( UTF8* name )
{
    S32 hash, i;
...
===============
*/
define_t* idParseSystemLocal::FindHashedDefine( define_t** definehash, UTF8* name )
{
    S32 hash;
    define_t* d;
...
===============
*/
S32 idParseSystemLocal::FindDefineParm( define_t* define, UTF8* name )
{
    S32 i;
    token_t* p;
...
===============
*/
S32 idParseSystemLocal::ExpandBuiltinDefine( source_t* source, token_t* deftoken, define_t* define, token_t** firsttoken, token_t** lasttoken )
{
    token_t* token;
    time_t t;
    ...
    switch ( define->builtin )
    {
        ...
        case BUILTIN_FILE:
        {
            ...
            token->type = TT_NAME;
            token->subtype = ( S32 )::strlen( token->string );
            *firsttoken = token;
            *lasttoken = token;
            break;
        }
...
===============
*/
S32 idParseSystemLocal::ExpandDefine( source_t* source, token_t* deftoken, define_t* define, token_t** firsttoken, token_t** lasttoken )
{
    S32 parmnum, i;
...
===============
*/
S32 idParseSystemLocal::ExpandDefineIntoSource( source_t* source, token_t* deftoken, define_t* define )
{
...
===============
*/
void idParseSystemLocal::ConvertPath( UTF8* path )
{
    UTF8* ptr;
...
===============
*/
S32 idParseSystemLocal::ReadLine( source_t* source, token_t* token )
{
    S32 crossline;
...
===============
*/
S32 idParseSystemLocal::OperatorPriority( S32 op )
{
    switch ( op )
    {
        case P_MUL:
...
===============
*/
S32 idParseSystemLocal::EvaluateTokens( source_t* source, token_t* tokens, S64* intvalue, F64* floatvalue, S32 integer )
{
...
===============
*/
S32 idParseSystemLocal::Evaluate( source_t* source, S64* intvalue, F64* floatvalue, S32 integer )
{
    S32 defined = false;
...
===============
*/
S32 idParseSystemLocal::DollarEvaluate( source_t* source, S64* intvalue, F64* floatvalue, S32 integer )
{
...
===============
*/
S32 idParseSystemLocal::Directive_include( source_t* source )
{
    UTF8 path[MAX_QPATH];
    script_t* script;
    token_t token;
...
===============
*/
S32 idParseSystemLocal::WhiteSpaceBeforeToken( token_t* token )
{
...
===============
*/
S32 idParseSystemLocal::Directive_undef( source_t* source )
{
    S32 hash;
    token_t token;
...
===============
*/
S32 idParseSystemLocal::Directive_elif( source_t* source )
{
    S32 type, skip;
    S64 value;
...
===============
*/
S32 idParseSystemLocal::Directive_if( source_t* source )
{
    S32 skip;
    S64 value;
...
===============
*/
S32 idParseSystemLocal::Directive_line( source_t* source )
{
...
===============
*/
S32 idParseSystemLocal::Directive_error( source_t* source )
{
    token_t token;
...
===============
*/
S32 idParseSystemLocal::Directive_pragma( source_t* source )
{
    token_t token;
...
===============
*/
S32 idParseSystemLocal::Directive_eval( source_t* source )
{
    S64 value;
    token_t token;
...
===============
*/
S32 idParseSystemLocal::Directive_evalfloat( source_t* source )
{
    F64 value;
    token_t token;
...
===============
*/
S32 idParseSystemLocal::DollarDirective_evalint( source_t* source )
{
    S64 value;
    token_t token;
...
===============
*/
S32 idParseSystemLocal::DollarDirective_evalfloat( source_t* source )
{
    F64 value;
    token_t token;
...
S32 idParseSystemLocal::ReadDollarDirective( source_t* source )
{
    S32 i;
    token_t token;
...
===============
*/
S32 idParseSystemLocal::Directive_if_def( source_t* source, S32 type )
{
    S32 skip;
    token_t token;
    define_t* d;
...
===============
*/
S32 idParseSystemLocal::Directive_ifdef( source_t* source )
{
...
===============
*/
S32 idParseSystemLocal::Directive_ifndef( source_t* source )
{
...
===============
*/
S32 idParseSystemLocal::Directive_else( source_t* source )
{
    S32 type, skip;
...
===============
*/
S32 idParseSystemLocal::Directive_endif( source_t* source )
{
    S32 type, skip;
...
===============
*/
S32 idParseSystemLocal::CheckTokenString( source_t* source, UTF8* string )
{
    token_t tok;
...
===============
*/
S32 idParseSystemLocal::Directive_define( source_t* source )
{
    token_t token, *t, *last;
    define_t* define;
    ...
    //allocate define
    define = ( define_t* )memorySystem->Malloc( sizeof( define_t ) + strlen( token.string ) + 1 );
...
===============
*/
S32 idParseSystemLocal::ReadDirective( source_t* source )
{
    S32 i;
    token_t token;
...
===============
*/
S32 idParseSystemLocal::ReadToken( source_t* source, token_t* token )
{
    define_t* define;
...
===============
*/
define_t* idParseSystemLocal::DefineFromString( UTF8* string )
{
    S32 res, i;
    script_t* script;
    source_t src;
    ...
    script = LoadScriptMemory( string, ( S32 )::strlen( string ), "*extern" );
    ...
    src.definehash = ( define_t** )memorySystem->Malloc( DEFINEHASHSIZE * sizeof( define_t* ) );
...
===============
*/
bool idParseSystemLocal::AddDefineToSourceFromString( source_t* source, UTF8* string )
{
    PushScript( source, LoadScriptMemory( string, ( S32 )::strlen( string ), "*extern" ) );
...
===============
*/
S32 idParseSystemLocal::AddGlobalDefine( UTF8* string )
{
...
define_t* idParseSystemLocal::CopyDefine( source_t* source, define_t* define )
{
    ...
    newdefine = ( define_t* )memorySystem->Malloc( sizeof( define_t ) + strlen( define->name ) + 1 );
...
===============
*/
source_t* idParseSystemLocal::LoadSourceFile( StringEntry filename )
{
    source_t* source;
    script_t* script;
    ...
    source->definehash = ( define_t** )memorySystem->Malloc( DEFINEHASHSIZE * sizeof( define_t* ) );
...
===============
*/
S32 idParseSystemLocal::LoadSourceHandle( StringEntry filename )
{
    S32 i;
    source_t* source;
...
===============
*/
S32 idParseSystemLocal::FreeSourceHandle( S32 handle )
{
...
===============
*/
S32 idParseSystemLocal::ReadTokenHandle( S32 handle, pc_token_t* pc_token )
{
    token_t token;
    S32 ret;
...
===============
*/
S32 idParseSystemLocal::SourceFileAndLine( S32 handle, UTF8* filename, S32* line )
{
    if ( handle < 1 || handle >= MAX_SOURCEFILES )
    {
        return false;
