...
#define QGL_DESKTOP_1_1_FIXED_FUNCTION_PROCS \
	...
	GLE(void, Vertex3d, GLdouble x, GLdouble y, GLdouble z ) \
...
#define QGL_2_0_PROCS \
	...
	GLE(void, Uniform2fv, GLuint program, GLint location, GLsizei count, const GLfloat *value) \
...
#define QGL_ARB_framebuffer_object_PROCS \
	...
	GLE(void, FramebufferTexture, GLuint framebuffer, GLenum attachment, GLuint texture, GLint level )\
...
#define QGL_ARB_vertex_array_object_PROCS \
    ...
    GLE(GLint, BindFragDataLocation, GLuint program,GLuint color, const GLchar *name)\
...
#define QGL_EXT_direct_state_access_PROCS \
	...
	GLE(GLvoid, ProgramUniform2fvEXT, GLuint program, GLint location, GLsizei count, const GLfloat *value) \
