...
void idRenderSystemInitLocal::Register( void )
{
    ...
    //postprocess effects
    r_lensflare = cvarSystem->Get( "rpp_lensflare", "0", CVAR_ARCHIVE, "description" );
    r_anamorphic = cvarSystem->Get( "rpp_anamorphic", "0", CVAR_ARCHIVE, "description" );
    r_anamorphicDarkenPower = cvarSystem->Get( "rpp_anamorphicDarkenPower", "256.0", CVAR_ARCHIVE, "description" );
    r_ssgi = cvarSystem->Get( "rpp_ssgi", "0", CVAR_ARCHIVE, "description" );
    r_ssgiWidth = cvarSystem->Get( "rpp_ssgiWidth", "8.0", CVAR_ARCHIVE, "description" );
    r_ssgiSamples = cvarSystem->Get( "rpp_ssgiSamples", "2", CVAR_ARCHIVE, "description" );
    r_ssr = cvarSystem->Get( "rpp_ssr", "0", CVAR_ARCHIVE, "description" );
    r_ssrStrength = cvarSystem->Get( "rpp_ssrStrength", "0.02", CVAR_ARCHIVE, "description" );
    r_sse = cvarSystem->Get( "rpp_sse", "0", CVAR_ARCHIVE, "description" );
    r_sseStrength = cvarSystem->Get( "rrpp_sseStrength", "0.02", CVAR_ARCHIVE, "description" );
    r_darkexpand = cvarSystem->Get( "rpp_darkexpand", "1", CVAR_ARCHIVE, "description" );
    r_dof = cvarSystem->Get( "rpp_dof", "0", CVAR_ARCHIVE, "description" );
    r_esharpening = cvarSystem->Get( "rpp_esharpening", "0", CVAR_ARCHIVE, "description" );
    r_esharpening2 = cvarSystem->Get( "rpp_esharpening2", "0", CVAR_ARCHIVE, "description" );
    r_multipost = cvarSystem->Get( "rpp_multipost", "0", CVAR_ARCHIVE, "description" );
    r_textureClean = cvarSystem->Get( "rpp_textureClean", "0", CVAR_ARCHIVE, "description" );
    r_textureCleanSigma = cvarSystem->Get( "rpp_textureCleanSigma", "1.2", CVAR_ARCHIVE, "description" );
    r_textureCleanBSigma = cvarSystem->Get( "rpp_textureCleanBSigma", "0.1", CVAR_ARCHIVE, "description" );
    r_textureCleanMSize = cvarSystem->Get( "rpp_textureCleanMSize", "6.0", CVAR_ARCHIVE, "description" );
    r_trueAnaglyph = cvarSystem->Get( "rpp_trueAnaglyph", "0", CVAR_ARCHIVE, "description" );
    r_trueAnaglyphSeparation = cvarSystem->Get( "rpp_trueAnaglyphSeparation", "8.0", CVAR_ARCHIVE, "description" );
    r_trueAnaglyphRed = cvarSystem->Get( "rpp_trueAnaglyphRed", "0.0", CVAR_ARCHIVE, "description" );
    r_trueAnaglyphGreen = cvarSystem->Get( "rpp_trueAnaglyphGreen", "0.0", CVAR_ARCHIVE, "description" );
    r_trueAnaglyphBlue = cvarSystem->Get( "rpp_trueAnaglyphBlue", "0.0", CVAR_ARCHIVE, "description" );
    r_vibrancy = cvarSystem->Get( "rpp_vibrancy", "2.04", CVAR_ARCHIVE, "description" );
    r_bloom = cvarSystem->Get( "rpp_bloom", "0", CVAR_ARCHIVE, "description" );
    r_bloomPasses = cvarSystem->Get( "rpp_bloomPasses", "2", CVAR_ARCHIVE, "description" );
    r_bloomDarkenPower = cvarSystem->Get( "rpp_bloomDarkenPower", "6.5", CVAR_ARCHIVE, "description" );
    r_bloomScale = cvarSystem->Get( "rpp_bloomScale", "0.5", CVAR_ARCHIVE, "description" );
    r_fxaa = cvarSystem->Get( "rpp_fxaa", "0", CVAR_ARCHIVE, "description" );
    r_textureDetail = cvarSystem->Get( "rpp_textureDetail", "0", CVAR_ARCHIVE, "description" );
    r_textureDetailStrength = cvarSystem->Get( "rpp_textureDetailStrength", "0.004", CVAR_ARCHIVE, "description" );
    r_rbm = cvarSystem->Get( "rpp_rbm", "0", CVAR_ARCHIVE, "description" );
    r_rbmStrength = cvarSystem->Get( "rpp_rbmStrength", "0.015", CVAR_ARCHIVE, "description" );
    r_screenblur = cvarSystem->Get( "rpp_screenBlur", "0", CVAR_ARCHIVE, "description" );
    r_brightness = cvarSystem->Get( "rpp_brightness", "0.0", CVAR_ARCHIVE, "description" );
    r_contrast = cvarSystem->Get( "rpp_contrast", "1.0", CVAR_ARCHIVE, "description" );
    r_gamma = cvarSystem->Get( "rpp_gamma", "1.0", CVAR_ARCHIVE, "description" );
