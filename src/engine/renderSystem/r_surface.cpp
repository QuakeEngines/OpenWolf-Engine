...
idRenderSystemSurfaceLocal renderSystemSurfaceLocal;

/*
===============
idRenderSystemSurfaceLocal::idRenderSystemSurfaceLocal
===============
*/
idRenderSystemSurfaceLocal::idRenderSystemSurfaceLocal( void )
{
}
...
/*
==============
idRenderSystemSurfaceLocal::CheckOverflow
==============
*/
void idRenderSystemSurfaceLocal::CheckOverflow( S32 verts, S32 indexes )
{
    ...
    {
        Com_Error( ERR_DROP, "idRenderSystemSurfaceLocal::CheckOverflow: verts > MAX (%d > %d)", verts, SHADER_MAX_VERTEXES );
    }
    if ( indexes >= SHADER_MAX_INDEXES )
    {
        Com_Error( ERR_DROP, "idRenderSystemSurfaceLocal::CheckOverflow: indices > MAX (%d > %d)", indexes, SHADER_MAX_INDEXES );
    }
...
/*
==============
idRenderSystemSurfaceLocal::CheckVao
==============
*/
void idRenderSystemSurfaceLocal::CheckVao( vao_t* vao )
{
    if ( vao != glState.currentVao )
    {
        ...
        idRenderSystemVaoLocal::BindVao( vao );
    }
...
/*
==============
idRenderSystemSurfaceLocal::AddQuadStampExt
==============
*/
void idRenderSystemSurfaceLocal::AddQuadStampExt( vec3_t origin, vec3_t left, vec3_t up, F32 color[4], F32 s1, F32 t1, F32 s2, F32 t2 )
{
    S32 ndx;
    S16 iNormal[4];
    U16 iColor[4];
    ...
    idRenderSystemVaoLocal::VaoPackNormal( iNormal, normal );
    ...
    idRenderSystemVaoLocal::VaoPackColor( iColor, color );
...
/*
==============
idRenderSystemSurfaceLocal::AddQuadStamp
==============
*/
void idRenderSystemSurfaceLocal::AddQuadStamp( vec3_t origin, vec3_t left, vec3_t up, F32 color[4] )
{
...
/*
==============
idRenderSystemSurfaceLocal::InstantQuad

based on Tess_InstantQuad from xreal
==============
*/
void idRenderSystemSurfaceLocal::InstantQuad2( vec4_t quadVerts[4], vec2_t texCoords[4] )
{
    idRenderSystemGlimpLocal::LogComment( "--- idRenderSystemSurfaceLocal::InstantQuad2 ---\n" );
    ...
    idRenderSystemShadeLocal::DrawElements( tess.numIndexes, tess.firstIndex );
...
==============
*/
void idRenderSystemSurfaceLocal::InstantQuad( vec4_t quadVerts[4] )
{
    vec2_t texCoords[4];
    ...
    InstantQuad2( quadVerts, texCoords );
}

/*
==============
idRenderSystemSurfaceLocal::SurfaceSprite
==============
*/
void idRenderSystemSurfaceLocal::SurfaceSprite( void )
{
    F32 radius, colors[4];
    vec3_t left, up;
    ...
    AddQuadStamp( ent->e.origin, left, up, colors );
}

/*
=============
idRenderSystemSurfaceLocal::SurfacePolychain
=============
*/
void idRenderSystemSurfaceLocal::SurfacePolychain( srfPoly_t* p )
{
    S32 i, numv;
    
    CheckVao( tess.vao );
    
    CheckOverflow( p->numVerts, 3 * ( p->numVerts - 2 ) );
...
/*
==============
idRenderSystemSurfaceLocal::SurfaceVertsAndIndexes
==============
*/
void idRenderSystemSurfaceLocal::SurfaceVertsAndIndexes( S32 numVerts, srfVert_t* verts, S32 numIndexes, U32* indexes, S32 dlightBits, S32 pshadowBits )
{
    S16* lightdir, * tangent, * normal;
    U16* color;
    S32 i;
    U32* inIndex, *outIndex;
    F32* xyz, *texCoords, *lightCoords;
    srfVert_t* dv;
    
    CheckVao( tess.vao );
    
    CheckOverflow( numVerts, numIndexes );
...
/*
==============
idRenderSystemSurfaceLocal::SurfaceVaoCached
==============
*/
bool idRenderSystemSurfaceLocal::SurfaceVaoCached( S32 numVerts, srfVert_t* verts, S32 numIndexes, U32* indexes, S32 dlightBits, S32 pshadowBits )
{
    bool recycleVertexBuffer = false, recycleIndexBuffer = false, endSurface = false;
    
    if ( !( !idRenderSystemShadeLocal::ShaderRequiresCPUDeforms( tess.shader ) && !tess.shader->isSky && !tess.shader->isPortal ) )
    {
        return false;
    }
    ...
    idRenderSystemVaoLocal::CacheCheckAdd( &endSurface, &recycleVertexBuffer, &recycleIndexBuffer, numVerts, numIndexes );
    ...
    idRenderSystemVaoLocal::CacheAddSurface( verts, numVerts, indexes, numIndexes );
...
/*
=============
idRenderSystemSurfaceLocal::SurfaceTriangles
=============
*/
void idRenderSystemSurfaceLocal::SurfaceTriangles( srfBspSurface_t* srf )
{
    if ( SurfaceVaoCached( srf->numVerts, srf->verts, srf->numIndexes, srf->indexes, srf->dlightBits, srf->pshadowBits ) )
    {
        return;
    }
    
    SurfaceVertsAndIndexes( srf->numVerts, srf->verts, srf->numIndexes, srf->indexes, srf->dlightBits, srf->pshadowBits );
}

/*
==============
idRenderSystemSurfaceLocal::SurfaceBeam
==============
*/
void idRenderSystemSurfaceLocal::SurfaceBeam( void )
{
#define NUM_BEAM_SEGS 6
    S32	i;
    refEntity_t* e;
    shaderProgram_t* sp = &tr.textureColorShader;
    vec3_t perpvec, direction, normalized_direction, start_points[NUM_BEAM_SEGS], end_points[NUM_BEAM_SEGS], oldorigin, origin;
    ...
    idRenderSystemBackendLocal::State( GLS_SRCBLEND_ONE | GLS_DSTBLEND_ONE );
    ...
    idRenderSystemVaoLocal::UpdateTessVao( ATTR_POSITION );
    ...
    idRenderSystemGLSLLocal::SetUniformVec4( sp, UNIFORM_COLOR, colorRed );
...
/*
==============
idRenderSystemSurfaceLocal::DoRailCore
==============
*/
void idRenderSystemSurfaceLocal::DoRailCore( const vec3_t start, const vec3_t end, const vec3_t up, F32 len, F32 spanWidth )
{
    S32 vbase;
    F32 spanWidth2, t = len / 256.0f;
    ...
    tess.color[tess.numVertexes][0] = ( U16 )( backEnd.currentEntity->e.shaderRGBA[0] * 0.25f * 257.0f );
    tess.color[tess.numVertexes][1] = ( U16 )( backEnd.currentEntity->e.shaderRGBA[1] * 0.25f * 257.0f );
    tess.color[tess.numVertexes][2] = ( U16 )( backEnd.currentEntity->e.shaderRGBA[2] * 0.25f * 257.0f );
    tess.numVertexes++;
...
/*
==============
idRenderSystemSurfaceLocal::DoRailDiscs
==============
*/
void idRenderSystemSurfaceLocal::DoRailDiscs( S32 numSegs, const vec3_t start, const vec3_t dir, const vec3_t right, const vec3_t up )
{
    S32 i, spanWidth = r_railWidth->integer;
    F32 c, s, scale;
    vec3_t	v, pos[4];
...
/*
==============
idRenderSystemSurfaceLocal::SurfaceRailRings
==============
*/
void idRenderSystemSurfaceLocal::SurfaceRailRings( void )
{
    S32 numSegs, len;
    refEntity_t* e;
    ...
    len = ( S32 )VectorNormalize( vec );
    MakeNormalVectors( vec, right, up );
    
    numSegs = ( S32 )( len / r_railSegmentLength->value );
...
/*
==============
idRenderSystemSurfaceLocal::SurfaceRailCore
==============
*/
void idRenderSystemSurfaceLocal::SurfaceRailCore( void )
{
    S32 len;
    refEntity_t* e;
    ...
    DoRailCore( start, end, right, ( F32 )len, r_railCoreWidth->value );
}

/*
==============
idRenderSystemSurfaceLocal::SurfaceLightningBolt
==============
*/
void idRenderSystemSurfaceLocal::SurfaceLightningBolt( void )
{
    S32 i, len;
    refEntity_t* e;
    vec3_t right, vec, start, end, v1, v2;
    ...
    for ( i = 0 ; i < 4 ; i++ )
    {
        ...
        DoRailCore( start, end, right, ( F32 )len, 8 );
...
/*
==============
idRenderSystemSurfaceLocal::LerpMeshVertexes
==============
*/
void idRenderSystemSurfaceLocal::LerpMeshVertexes( mdvSurface_t* surf, F32 backlerp )
{
    S32	vertNum;
    F32* outXyz;
...
/*
=============
idRenderSystemSurfaceLocal::SurfaceMesh
=============
*/
void idRenderSystemSurfaceLocal::SurfaceMesh( mdvSurface_t* surface )
{
    S32 j, Bob, Doug, numVerts;
    F32 backlerp;
    mdvSt_t* texCoords;
    ...
    CheckOverflow( surface->numVerts, surface->numIndexes );
...
/*
==============
idRenderSystemSurfaceLocal::SurfaceFace
==============
*/
void idRenderSystemSurfaceLocal::SurfaceFace( srfBspSurface_t* srf )
{
    if ( SurfaceVaoCached( srf->numVerts, srf->verts, srf->numIndexes, srf->indexes, srf->dlightBits, srf->pshadowBits ) )
    {
        return;
...
/*
==============
idRenderSystemSurfaceLocal::LodErrorForVolume
==============
*/
F32 idRenderSystemSurfaceLocal::LodErrorForVolume( vec3_t local, F32 radius )
{
    F32 d;
    vec3_t world;
...
/*
=============
idRenderSystemSurfaceLocal::SurfaceGrid

Just copy the grid of points and triangulate
=============
*/
void idRenderSystemSurfaceLocal::SurfaceGrid( srfBspSurface_t* srf )
{
    S32 i, j, rows, irows, vrows, used, widthTable[MAX_GRID_SIZE], heightTable[MAX_GRID_SIZE], lodWidth, lodHeight, numVertexes, dlightBits, pshadowBits;
    F32* xyz, *texCoords, *lightCoords;
    S16* normal, * tangent, *lightdir;
    U16* color;
    F32	lodError;
    srfVert_t*	dv;
    //S32 *vDlightBits;
...
/*
===================
idRenderSystemSurfaceLocal::SurfaceAxis

Draws x/y/z lines from the origin for orientation debugging
===================
*/
void idRenderSystemSurfaceLocal::SurfaceAxis( void )
{
    // FIXME: implement this
#if 0
    idRenderSystemBackendLocal::BindToTMU( tr.whiteImage, TB_COLORMAP );
    idRenderSystemBackendLocal::State( GLS_DEFAULT );
    qglLineWidth( 3 );
    qglBegin( GL_LINES );
    qglColor3f( 1, 0, 0 );
    qglVertex3f( 0, 0, 0 );
...
/*
====================
idRenderSystemSurfaceLocal::SurfaceEntity

Entities that have a single procedurally generated surface
====================
*/
void idRenderSystemSurfaceLocal::SurfaceEntity( surfaceType_t* surfType )
{
...
/*
==============
idRenderSystemSurfaceLocal::SurfaceBad
==============
*/
void idRenderSystemSurfaceLocal::SurfaceBad( surfaceType_t* surfType )
{
    clientMainSystem->RefPrintf( PRINT_ALL, "idRenderSystemSurfaceLocal::SurfaceBad - Bad surface tesselated.\n" );
}

/*
==============
idRenderSystemSurfaceLocal::SurfaceFlare
==============
*/
void idRenderSystemSurfaceLocal::SurfaceFlare( srfFlare_t* surf )
{
    if ( r_flares->integer )
    {
        idRenderSystemFlaresLocal::AddFlare( surf, tess.fogNum, surf->origin, surf->color, surf->normal );
    }
}

/*
==============
idRenderSystemSurfaceLocal::SurfaceVaoMdvMesh
==============
*/
void idRenderSystemSurfaceLocal::SurfaceVaoMdvMesh( srfVaoMdvMesh_t* surface )
{
    //mdvModel_t     *mdvModel;
    //mdvSurface_t   *mdvSurface;
    refEntity_t*    refEnt;
    
    idRenderSystemGlimpLocal::LogComment( "--- idRenderSystemSurfaceLocal::SurfaceVaoMdvMesh ---\n" );
    
    if ( idRenderSystemShadeLocal::ShaderRequiresCPUDeforms( tess.shader ) )
    {
        SurfaceMesh( surface->mdvSurface );
        return;
    }
...
==============
*/
void idRenderSystemSurfaceLocal::SurfaceSkip( void* surf )
{
}

void ( *rb_surfaceTable[SF_NUM_SURFACE_TYPES] )( void* ) =
{
    ( void(* )( void* ) )idRenderSystemSurfaceLocal::SurfaceBad,			// SF_BAD,
    ( void(* )( void* ) )idRenderSystemSurfaceLocal::SurfaceSkip,			// SF_SKIP,
    ( void(* )( void* ) )idRenderSystemSurfaceLocal::SurfaceFace,			// SF_FACE,
    ( void(* )( void* ) )idRenderSystemSurfaceLocal::SurfaceGrid,			// SF_GRID,
    ( void(* )( void* ) )idRenderSystemSurfaceLocal::SurfaceTriangles,		// SF_TRIANGLES,
    ( void(* )( void* ) )idRenderSystemSurfaceLocal::SurfacePolychain,		// SF_POLY,
    ( void(* )( void* ) )idRenderSystemSurfaceLocal::SurfaceMesh,			// SF_MDV,
    ( void(* )( void* ) )idRenderSystemAnimationLocal::MDRSurfaceAnim,		// SF_MDR,
    ( void(* )( void* ) )idRenderSystelModelIQMLocal::IQMSurfaceAnim,		// SF_IQM,
    ( void(* )( void* ) )idRenderSystemSurfaceLocal::SurfaceFlare,		// SF_FLARE,
    ( void(* )( void* ) )idRenderSystemSurfaceLocal::SurfaceEntity,		// SF_ENTITY
    ( void(* )( void* ) )idRenderSystemSurfaceLocal::SurfaceVaoMdvMesh,  // SF_VAO_MDVMESH
    ( void(* )( void* ) )idRenderSystelModelIQMLocal::IQMSurfaceAnimVao, // SF_VAO_IQM
};
