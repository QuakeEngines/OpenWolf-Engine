...
void idServerDemoSystemLocal::DemoStartPlayback( void )
{
    ...
    if ( sv_democlients->integer < clients )
    {
        ...
        cvarSystem->SetValue( "sv_democlients", ( F32 )clients );
        cvarSystem->SetValue( "sv_maxclients", ( F32 )( clients + count ) );
    }
...
void idServerDemoSystemLocal::DemoStopPlayback( void )
{
    ...
    cvarSystem->SetValue( "sv_maxclients", ( F32 )savedMaxClients );
    cvarSystem->SetValue( "sv_democlients", ( F32 )savedDemoClients );
