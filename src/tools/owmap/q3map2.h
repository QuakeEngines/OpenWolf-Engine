...
// moved this to a external header so the physics engine can use it.
...
Q_EXTERN const char* surfaceTypes[NUM_SURFACE_TYPES]
#ifndef MAIN_C
;
#else
=
...
Q_EXTERN qboolean g_forceVertex Q_ASSIGN( qfalse );
