...
void BasePortalVis( int portalnum )
{
    ...
    p->portalfront = static_cast<byte*>( safe_malloc( portalbytes ) );
    memset( p->portalfront, 0, portalbytes );
    
    p->portalflood = static_cast<byte*>( safe_malloc( portalbytes ) );
    memset( p->portalflood, 0, portalbytes );
    
    p->portalvis = static_cast<byte*>( safe_malloc( portalbytes ) );
